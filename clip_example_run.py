...
def run(
    coco_img_root='/data1/yx/suda/image-text/data/images/coco2014',
    coco_ann_path='/data1/yx/suda/image-text/data/coco2014/captions_val2014.json',
):
    # Prepare metric
    metric = Metrics()
    ...
    # Load the model
    device = "cuda"
    model, preprocess = clip.load('/data1/yx/suda/image-text/sotas/CLIP/output/Retrieval_coco_rebuild/ViT-B-32/checkpoint_best.pth', device)
